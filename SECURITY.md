...
For security vulnerabilities in the upstream **llama.cpp inference engine**, please report directly to [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp/security/advisories/new).
